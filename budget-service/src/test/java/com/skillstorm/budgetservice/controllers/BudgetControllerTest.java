...
public class BudgetControllerTest {
    ...
    void testCreateBudget() throws Exception {
        ...
        Budget budget = new Budget(1, 1, "Food", BigDecimal.valueOf(100), true, LocalDate.of(2023, 5, 1), "Note 1",
                null);
    ...
    void testGetTranscationsByMonthYear() throws Exception {
        ...
        List<TransactionDTO> transactions = Arrays.asList(
                new TransactionDTO(1, 1, 1, "Vendor1", 100.0, "Category1", "Description1", LocalDate.of(2023, 5, 1)));
