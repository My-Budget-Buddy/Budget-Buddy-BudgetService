package com.skillstorm.budgetservice.aspects;
...
public class LoggingAspect {
    ...
    // Pointcut for all methods in the com.skillstorm.budgetservice package:
    @Pointcut("within(com.skillstorm.budgetservice..*)")
    ...
    public Object log(ProceedingJoinPoint pjp) throws Throwable {
        ...
        // We don't want the logger to consume the exception, so if we catch one here
